...
@php
    ...
    $heroSubtitle = $settings['hero_subtitle'] ?? 'Escape the ordinary and dive into the wonders of Flores Island. From sailing on a Phinisi boat through Komodo National Park, hiking to Wae Rebo\'s hidden village, to witnessing the magic of Kelimutu\'s three-colored lakes — every moment is designed to amaze you. With trusted local guides and tailor-made trips, we take care of the details so you can live the adventure.';
    $wa = \App\Models\Setting::get('contact_wa', '6281239523657');
    $waUrl = 'https://wa.me/' . $wa . '?text=' . urlencode('Hello! I\'d like to start my journey to Flores. Can you help me plan my trip?');
@endphp
...
<section id="hero"
    ...
    <div class="relative z-10 section-padding pb-20 md:pb-28 max-w-4xl">
        ...
        <div class="flex flex-wrap gap-4 opacity-0" id="hero-cta">
            ...
            <a href="{{ $waUrl }}" target="_blank" rel="noopener" class="btn-outline" style="border-color: rgba(248,245,240,0.4); color: #F8F5F0;">Start Your Journey
            </a>
        </div>
    </div>
</section>
...
<section class="py-24 md:py-32 bg-[#F8F5F0]">
    <div class="section-padding">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
                <p class="section-subtitle mb-4">Tour Package Options</p>
                <h2 class="section-title">We offer various tour packages in Flores Island</h2>
            </div>
...
<section class="py-24 md:py-32" style="background-color: #0F172A;">
    <div class="section-padding">
        ...
        {{-- Section Header --}}
        <div class="mb-16">
            <p class="section-subtitle mb-4" style="color: #D6B98C;"><Explore the Wonders of Flores/p>
            <h2 class="section-title" style="color: #F8F5F0;">Top Destinations You Can’t Miss</h2>
        </div>
...
<section class="py-24 md:py-32 bg-[#F8F5F0]">
    <div class="section-padding">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            {{-- Right: Content --}}
            <div class="lg:pl-10">
                <p class="section-subtitle mb-4">Your Journey, Our Expertise</p>
                <h2 class="section-title mb-8">Why Travel
with Us?<br>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    @php
                        $reasons = [
                            ['icon' => 'M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7', 'title' => 'Local Expert Guides', 'desc' => 'discover Flores through authentic stories and insights.'],
                            ['icon' => 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z', 'title' => 'Comfort & Safety', 'desc' => 'We take care of every detail, you just enjoy the journey.'],
                            ['icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z', 'title' => '8+ Years Experience', 'desc' => 'Trusted by thousands of happy travelers.'],
...
<section class="py-24 md:py-32" style="background-color: #1E3A5F;">
    <div class="section-padding">
        ...
        <div class="text-center mb-16">
            <p class="section-subtitle mb-4" style="color: #D6B98C;">Stories from Happy Travelers</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-[#F8F5F0]/5 backdrop-blur-sm border border-[#F8F5F0]/10 p-8 flex flex-col gap-5">
                ...
                {{-- Opening quote mark --}}
                <p class="text-[#D6B98C]/40 text-5xl font-light leading-none -mb-2" style="font-family: 'Cormorant Garamond', serif;">&ldquo;</p>
